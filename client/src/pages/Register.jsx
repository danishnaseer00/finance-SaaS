      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-dark-800 rounded-2xl shadow-xl dark:shadow-none border border-gray-200 dark:border-dark-700 p-8">
          ...
          <button
            ...
            className="w-full py-3 bg-white dark:bg-dark-700 border border-gray-200 dark:border-dark-600 hover:bg-gray-50 dark:hover:bg-dark-600 text-gray-700 dark:text-gray-300 font-semibold rounded-xl transition flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
          >
